...
phase4_post.o:     file format elf32-i386
...
00000000 <do_phase>:
  ...
  5a:	ff e0                	jmp    *%eax
  5c:	c6 45 d7 7b          	movb   $0x7b,-0x29(%ebp) ; x        1  A  00
  60:	e9 9e 00 00 00       	jmp    103 <do_phase+0x103>
  65:	c6 45 d7 37          	movb   $0x37,-0x29(%ebp) ; 7        2  B  04
  69:	e9 95 00 00 00       	jmp    103 <do_phase+0x103>
  6e:	c6 45 d7 35          	movb   $0x35,-0x29(%ebp) ; 5        3  C  08
  72:	e9 8c 00 00 00       	jmp    103 <do_phase+0x103>
  77:	c6 45 d7 74          	movb   $0x74,-0x29(%ebp) ; t        4  D  0c
  7b:	e9 83 00 00 00       	jmp    103 <do_phase+0x103>
  80:	c6 45 d7 34          	movb   $0x34,-0x29(%ebp) ; 4        5  E  10
  84:	eb 7d                	jmp    103 <do_phase+0x103>
  86:	c6 45 d7 38          	movb   $0x38,-0x29(%ebp) ; 8   [8]  6  F  14
  8a:	eb 77                	jmp    103 <do_phase+0x103>
  8c:	c6 45 d7 3c          	movb   $0x3c,-0x29(%ebp) ; <        7  G  18
  90:	eb 71                	jmp    103 <do_phase+0x103>
  92:	c6 45 d7 40          	movb   $0x40,-0x29(%ebp) ; @        8  H  1c
  96:	eb 6b                	jmp    103 <do_phase+0x103>
  98:	c6 45 d7 49          	movb   $0x49,-0x29(%ebp) ; I        9  I  20
  9c:	eb 65                	jmp    103 <do_phase+0x103>
  9e:	c6 45 d7 39          	movb   $0x39,-0x29(%ebp) ; 9        10 G  24
  a2:	eb 5f                	jmp    103 <do_phase+0x103>
  a4:	c6 45 d7 30          	movb   $0x30,-0x29(%ebp) ; 0   [0]  11 K  28
  a8:	eb 59                	jmp    103 <do_phase+0x103>
  aa:	c6 45 d7 5b          	movb   $0x5b,-0x29(%ebp) ; [        12 L  2c
  ae:	eb 53                	jmp    103 <do_phase+0x103>
  b0:	c6 45 d7 6f          	movb   $0x6f,-0x29(%ebp) ; o        13 M  30
  b4:	eb 4d                	jmp    103 <do_phase+0x103>
  b6:	c6 45 d7 63          	movb   $0x63,-0x29(%ebp) ; c        14 N  34
  ba:	eb 47                	jmp    103 <do_phase+0x103>
  bc:	c6 45 d7 3f          	movb   $0x3f,-0x29(%ebp) ; ?        15 O  38
  c0:	eb 41                	jmp    103 <do_phase+0x103>
  c2:	c6 45 d7 32          	movb   $0x32,-0x29(%ebp) ; 2   [2]  16 P  3c
  c6:	eb 3b                	jmp    103 <do_phase+0x103>
  c8:	c6 45 d7 62          	movb   $0x62,-0x29(%ebp) ; b        17 Q  40
  cc:	eb 35                	jmp    103 <do_phase+0x103>
  ce:	c6 45 d7 56          	movb   $0x56,-0x29(%ebp) ; V        18 R  44
  d2:	eb 2f                	jmp    103 <do_phase+0x103>
  d4:	c6 45 d7 33          	movb   $0x33,-0x29(%ebp) ; 3   [3]  19 S  48
  d8:	eb 29                	jmp    103 <do_phase+0x103>
  da:	c6 45 d7 5d          	movb   $0x5d,-0x29(%ebp) ; ]        20 T  4c
  de:	eb 23                	jmp    103 <do_phase+0x103>
  e0:	c6 45 d7 31          	movb   $0x31,-0x29(%ebp) ; 1   [1]  21 U  50
  e4:	eb 1d                	jmp    103 <do_phase+0x103>
  e6:	c6 45 d7 36          	movb   $0x36,-0x29(%ebp) ; 6        22 V  54
  ea:	eb 17                	jmp    103 <do_phase+0x103>
  ec:	c6 45 d7 63          	movb   $0x63,-0x29(%ebp) ; c        23 W  58
  f0:	eb 11                	jmp    103 <do_phase+0x103>
  f2:	c6 45 d7 74          	movb   $0x74,-0x29(%ebp) ; t        24 X  5c
  f6:	eb 0b                	jmp    103 <do_phase+0x103>
  f8:	c6 45 d7 49          	movb   $0x49,-0x29(%ebp) ; I        25 Y  60
  fc:	eb 05                	jmp    103 <do_phase+0x103>
  fe:	c6 45 d7 69          	movb   $0x69,-0x29(%ebp) ; i        26 Z  64
 102:	90                   	nop
