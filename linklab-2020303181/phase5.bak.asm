...
00000081 <generate_code>:
  ...
  8a:	a2 00 00 00 00       	mov    %al,0x0 ; !! no relocation
  ...
  a5:	50                   	push   %eax
  a6:	e8 fc ff ff ff       	call   a7 <generate_code+0x26> ; tranform_code
...
000000c2 <encode>:
  ...
  ce:	e8 fc ff ff ff       	call   cf <encode+0xd> ; strlen
