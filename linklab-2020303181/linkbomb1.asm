...
linkbomb1:     file format elf32-i386
...
08048810 <_start>:
 ...
 8048819:	54                   	push   %esp
 804881a:	52                   	push   %edx
 804881b:	68 80 92 04 08       	push   $0x8049280
 8048820:	68 20 92 04 08       	push   $0x8049220
 8048825:	51                   	push   %ecx
 8048826:	56                   	push   %esi
...
08048850 <deregister_tm_clones>:
 8048850:	b8 ff b0 04 08       	mov    $0x804b0ff,%eax
 8048855:	2d fc b0 04 08       	sub    $0x804b0fc,%eax
 ...
 804886e:	68 fc b0 04 08       	push   $0x804b0fc
...
08048880 <register_tm_clones>:
 8048880:	b8 fc b0 04 08       	mov    $0x804b0fc,%eax
 8048885:	2d fc b0 04 08       	sub    $0x804b0fc,%eax
 ...
 80488a7:	50                   	push   %eax
 80488a8:	68 fc b0 04 08       	push   $0x804b0fc
...
080488c0 <__do_global_dtors_aux>:
 80488c0:	80 3d 24 b1 04 08 00 	cmpb   $0x0,0x804b124
 ...
 80488d4:	c6 05 24 b1 04 08 01 	movb   $0x1,0x804b124
 80488db:	c9                   	leave  
...
0804890b <file_size>:
 ...
 804892c:	e8 5f 09 00 00       	call   8049290 <__stat>
...
08048950 <sendfile>:
 ...
 8048987:	68 d0 92 04 08       	push   $0x80492d0
 ...
 8048a3b:	a1 34 b1 04 08       	mov    0x804b134,%eax
 8048a40:	83 f8 03             	cmp    $0x3,%eax
 8048a43:	0f 85 c3 00 00 00    	jne    8048b0c <sendfile+0x1bc>
 8048a49:	83 ec 08             	sub    $0x8,%esp
 8048a4c:	68 d0 92 04 08       	push   $0x80492d0
 8048a51:	68 d2 92 04 08       	push   $0x80492d2
 ...
 8048a70:	68 e1 92 04 08       	push   $0x80492e1
...
08048b24 <client>:
 ...
 8048b8f:	68 fb 92 04 08       	push   $0x80492fb
 ...
 8048ba5:	a3 34 b1 04 08       	mov    %eax,0x804b134
 8048baa:	83 ec 04             	sub    $0x4,%esp
 8048bad:	ff 75 08             	pushl  0x8(%ebp)
 8048bb0:	68 08 93 04 08       	push   $0x8049308
 ...
 8048c6b:	a1 30 b1 04 08       	mov    0x804b130,%eax
 ...
 8048cb7:	68 0c 93 04 08       	push   $0x804930c
 ...
 8048cf9:	68 30 93 04 08       	push   $0x8049330
 ...
 8048d7b:	68 64 93 04 08       	push   $0x8049364
 ...
 8048e3b:	68 94 93 04 08       	push   $0x8049394
 ...
 8048e81:	68 c4 93 04 08       	push   $0x80493c4
 ...
 8048f29:	68 e8 93 04 08       	push   $0x80493e8
 ...
 8048f5f:	68 14 94 04 08       	push   $0x8049414
 ...
 8048f7f:	68 20 94 04 08       	push   $0x8049420
 ...
 8048f97:	68 50 94 04 08       	push   $0x8049450
 ...
 8048fac:	68 14 94 04 08       	push   $0x8049414
...
080490d7 <main>:
 ...
 80490eb:	a1 00 b1 04 08       	mov    0x804b100,%eax
 80490f0:	a3 28 b1 04 08       	mov    %eax,0x804b128
 ...
 8049155:	68 1d 96 04 08       	push   $0x804961d
 ...
 8049170:	a1 2c b1 04 08       	mov    0x804b12c,%eax
 8049175:	85 c0                	test   %eax,%eax
 8049177:	74 37                	je     80491b0 <main+0xd9>
 8049179:	a1 30 b1 04 08       	mov    0x804b130,%eax
 ...
 804918a:	50                   	push   %eax
 804918b:	68 24 96 04 08       	push   $0x8049624
...
080491e1 <do_phase>:
 ...
 80491e7:	b8 a7 b0 04 08       	mov    $0x804b0a7,%eax
 80491ec:	83 ec 0c             	sub    $0xc,%esp
 80491ef:	50                   	push   %eax
 80491f0:	e8 3b f5 ff ff       	call   8048730 <puts@plt>
 80491f5:	83 c4 10             	add    $0x10,%esp
 80491f8:	a1 2c b1 04 08       	mov    0x804b12c,%eax
 80491fd:	83 f8 01             	cmp    $0x1,%eax
 8049200:	75 13                	jne    8049215 <do_phase+0x34>
 8049202:	b8 a7 b0 04 08       	mov    $0x804b0a7,%eax
 8049207:	83 ec 08             	sub    $0x8,%esp
 804920a:	50                   	push   %eax
 804920b:	6a 01                	push   $0x1
 804920d:	e8 12 f9 ff ff       	call   8048b24 <client>
...
08049220 <__libc_csu_init>:
 ...
 8049222:	56                   	push   %esi
 8049223:	53                   	push   %ebx
 8049224:	e8 17 f6 ff ff       	call   8048840 <__x86.get_pc_thunk.bx>
 8049229:	81 c3 d7 1d 00 00    	add    $0x1dd7,%ebx
 804922f:	83 ec 0c             	sub    $0xc,%esp
 8049232:	8b 6c 24 20          	mov    0x20(%esp),%ebp
 8049236:	8d b3 0c ff ff ff    	lea    -0xf4(%ebx),%esi
 804923c:	e8 f7 f3 ff ff       	call   8048638 <_init>
 8049241:	8d 83 08 ff ff ff    	lea    -0xf8(%ebx),%eax
 8049247:	29 c6                	sub    %eax,%esi
 8049249:	c1 fe 02             	sar    $0x2,%esi
 804924c:	85 f6                	test   %esi,%esi
 804924e:	74 25                	je     8049275 <__libc_csu_init+0x55>
 8049250:	31 ff                	xor    %edi,%edi
 8049252:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 8049258:	83 ec 04             	sub    $0x4,%esp
 804925b:	ff 74 24 2c          	pushl  0x2c(%esp)
 804925f:	ff 74 24 2c          	pushl  0x2c(%esp)
 8049263:	55                   	push   %ebp
 8049264:	ff 94 bb 08 ff ff ff 	call   *-0xf8(%ebx,%edi,4)
 804926b:	83 c7 01             	add    $0x1,%edi
 804926e:	83 c4 10             	add    $0x10,%esp
 8049271:	39 f7                	cmp    %esi,%edi
 8049273:	75 e3                	jne    8049258 <__libc_csu_init+0x38>
 8049275:	83 c4 0c             	add    $0xc,%esp
 8049278:	5b                   	pop    %ebx
 8049279:	5e                   	pop    %esi
 804927a:	5f                   	pop    %edi
 804927b:	5d                   	pop    %ebp
...
08049280 <__libc_csu_fini>:
 8049280:	f3 c3                	repz ret 
 8049282:	66 90                	xchg   %ax,%ax
...
08049290 <__stat>:
 8049290:	53                   	push   %ebx
 8049291:	e8 aa f5 ff ff       	call   8048840 <__x86.get_pc_thunk.bx>
 8049296:	81 c3 6a 1d 00 00    	add    $0x1d6a,%ebx
 804929c:	83 ec 0c             	sub    $0xc,%esp
 804929f:	ff 74 24 18          	pushl  0x18(%esp)
 80492a3:	ff 74 24 18          	pushl  0x18(%esp)
 80492a7:	6a 03                	push   $0x3
 80492a9:	e8 32 f4 ff ff       	call   80486e0 <__xstat@plt>
 80492ae:	83 c4 18             	add    $0x18,%esp
 80492b1:	5b                   	pop    %ebx
 80492b2:	c3                   	ret    
...
080492b4 <_fini>:
 ...
 80492b8:	e8 83 f5 ff ff       	call   8048840 <__x86.get_pc_thunk.bx>
 80492bd:	81 c3 43 1d 00 00    	add    $0x1d43,%ebx
 80492c3:	83 c4 08             	add    $0x8,%esp
 80492c6:	5b                   	pop    %ebx
 80492c7:	c3                   	ret    
